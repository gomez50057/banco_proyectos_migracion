...
const Login = () => {
  ...
  const redirectByGroup = useCallback((group) => {
    switch (group) {
      case 'responsable': router.push('/panel-responsable'); break;
      case 'visualizador': router.push('/panel-proyectos'); break;
      case 'cliente': router.push('/panel-usuario'); break;
      case 'proyectos-infraestructura-2025': router.push('/centro-proyectos-infraestructura-2025'); break;
