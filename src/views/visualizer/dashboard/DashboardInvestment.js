...
const DashboardInvestment = () => {
  ...
  return (
    <div className={styles['dashboard-container']}>
      <h2 className={styles['dashboard-title']}>Dashboard de Inversiones</h2>
      {/* Mostrar el total de proyectos */}
      <p className={styles['total-proyectos']}>Total de proyectos por unidad responsable: {totalProyectosUnidad}</p>
