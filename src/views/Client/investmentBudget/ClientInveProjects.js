...
// Archivo: src/pages/Client/ClientInveProjects.js
...
const ClientProjects = () => {
  ...
  const handleEditClick = (projectId) => {
    ...
    router.push(`/editar-proyecto-inversion/${projectId}`);
  };
  ...
  return (
    <ThemeProvider theme={getMuiTheme()}>
      ...
      <div className="table_grid_pro">
        <MUIDataTable
          title={<Typography variant="h3">Proyectos de Inversión Registrados</Typography>}
          data={projects}
          columns={columns}
          options={options}
        />
